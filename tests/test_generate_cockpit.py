...
class CockpitGenerationTests(unittest.TestCase):
    ...
    def test_generate_portable_bundle(self):
        result = generate(self.instance, self.output, "SAME_INCUMBENT_RECOVERY")
    ...
    def test_existing_destination_is_not_overwritten(self):
        ...
        with self.assertRaises(Invalid):
            generate(self.instance, self.output, "SAME_INCUMBENT_RECOVERY")
        self.assertEqual(marker.read_text(encoding="utf-8"), "keep")

    def test_supersession_aware_recovery(self):
        generate(self.instance, self.output, "SAME_INCUMBENT_RECOVERY", "workstream:atlas-release-readiness")
